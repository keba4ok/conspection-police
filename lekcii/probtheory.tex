...
\begin{exl}
    ...
    \begin{itemize}
        ...
        \item \hypertarget{n10}{\textcolor{cyan}{\textit{биномиальное}}}: $B(n, o)$, $p\in[0,1]$, $X\sim B(n, p)$, если принимаются значения от $0$ до $n$, причём $\PP\{X=k\}=\PP_n(k)$ (просто обозначение), и равно $C_n^kp^k(1-p)^{n-k}$.
    \end{itemize}
